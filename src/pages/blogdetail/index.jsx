...
const Blogdetail = (props) => {
                            ...
                            <div className="row">
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog__details__btn__item">
                                        <h6><a href="/#"><i className="fa fa-angle-left"></i> Previous posts</a></h6>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog__details__btn__item blog__details__btn__item--next">
                                        <h6><a href="/#">Next posts <i className="fa fa-angle-right"></i></a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    {props.bd &&
         <Instagram insta={props.bd.instagram}/>   
    }
        </>
    )
}
